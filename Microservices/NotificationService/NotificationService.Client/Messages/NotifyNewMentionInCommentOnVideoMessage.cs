...
public class NotifyNewMentionInCommentOnVideoMessage : IMessageBase
{
    ...
    [ProtoTopField(1)] public NotificationEvent Event { get; set; } = NotificationEvent.NewMentionInCommentOnVideo;
