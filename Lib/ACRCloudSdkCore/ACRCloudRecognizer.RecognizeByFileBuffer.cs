...
namespace ACRCloudSdkCore
{
    public partial class ACRCloudRecognizer
    {
        ...
        public Task<ACRCloudRecognizeResult?> RecognizeByFileAsync(
            byte[] fileBuffer,
        ...
        {
            return RecognizeByFileAsync(
                fileBuffer,
                startTime,
                TimeSpan.FromSeconds(ACRCloudExtractTools.DefaultDurationSeconds),
                type,
                token
            );
        }
        ...
        )
        {
            return RecognizeByFileAsync(
                ...
                duration,
                isDB,
                DefaultMinFilterEnergy,
                DefaultSilenceEnergyThreshold,
                DefaultSilenceRateThreshold,
                type,
                token
            );
        }
        ...
        )
        {
            return RecognizeByFileAsync(
                ...
                isDB,
                minFilterEnergy,
                silenceEnergyThreshold,
                silenceRateThreshold,
                type,
                token
            );
        }
        ...
        )
        {
            IEnumerable<KeyValuePair<string?, string?>> getContents()
            {
                ...
                {
                    byte[] audio = ACRCloudExtractTools.CreateFingerprintByFile(
                        fileBuffer.Span,
                        startTime,
                        duration,
                        isDB,
